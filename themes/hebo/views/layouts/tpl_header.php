...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?php echo $baseUrl; ?>/js/jquery.smartCart-2.0.js"></script>
        ...
        <link href="<?php echo $baseUrl; ?>/css/smart_cart.css" rel="stylesheet" type="text/css">
