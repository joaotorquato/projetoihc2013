...
//                                )),
                            array('label' => 'Pratos <span class="caret"></span>', 'url' => array('/site/page', 'view' => 'columns'), 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown", "data-description" => "Por categoria"),
                                'items' => array(
                            ...
                            array('label' => 'Restaurantes <span class="caret"></span>', 'url' => array('/site/page', 'view' => 'columns'), 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown", "data-description" => "Por categoria"),
                                'items' => array(
                                    array('label' => '- Ver Restaurantes', 'url' => array('/site/page', 'view' => 'columns')),
                                )),
                            array('label' => 'Plano Mensal', 'url' => array('/site/page', 'view' => 'pricing-tables'), 'linkOptions' => array("data-description" => "Sua entrega marcada"),
                                'items' => array(
                                    array('label' => '- Assinar Plano', 'url' => array('/site/page', 'view' => 'columns')),
                                    array('label' => '- Meu Plano', 'url' => array('/site/page', 'view' => 'columns')),
                                )),
                            array('label' => 'Sobre', 'url' => array('/site/page', 'view' => 'about'), 'linkOptions' => array("data-description" => "Quem somos"),),
