        ...
        <div class="span6">
            ...
            <table class="table table-striped table-bordered table-hover" style='height: 320px;'>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style='text-align:center;' colspan="2"><?php echo CHtml::button("Contratar Plano", array('title' => "Contratar Plano", 'style' => 'margin:auto;', 'onclick' => 'js:confirmar(' . $key . ');', 'class' => 'btn btn-success')); ?></td>
                    </tr>
                </tbody>
            </table>
